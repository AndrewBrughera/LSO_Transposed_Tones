# -*- coding: utf-8 -*-
"""
Model LSO Neuron Type 1v - Andrew Brughera January 2019 to April 2020, 
...
#    We = We.replace('.','p')
    ...
    lsonSpkFile = 'Lso1vSpT' + anCoSpkFile[6:13] + anCoSpkFile[16:21] + anCoSpkFile[24:31] + 'Te'+Te + 'We'+We + 'Ti'+Ti + 'Wi'+Wi + EIPDstr + 'C' + anCoSpkFile[46:48] + anCoSpkFile[31:33] + anCoSpkFile[35:39] + anCoSpkFile[53:]
