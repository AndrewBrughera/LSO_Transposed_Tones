# -*- coding: utf-8 -*-
"""
Model LSO Neuron Type "2z" - Andrew Brughera 2019 January to September, 
...
#    EIPD = (EPhsIntCo - EPhsIntIp) % 360
    ...
    lsonSpkFile = 'Lso2zSpT' + anCoSpkFile[6:13] + anCoSpkFile[16:21] + anCoSpkFile[24:31] + 'Te'+Te + 'We'+We + 'Ti'+Ti + 'Wi'+Wi + EIPDstr + 'C' + anCoSpkFile[46:48] + anCoSpkFile[31:33] + anCoSpkFile[35:39] + anCoSpkFile[53:]
