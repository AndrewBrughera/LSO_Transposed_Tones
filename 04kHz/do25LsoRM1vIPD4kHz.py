# -*- coding: utf-8 -*-
"""
do25LsoRM1vIPD4kHz.py

Calls a model LSO neuron type 1v non-principal,fast membrane,very fast synapses 
lson from lson25RM1v.py) with input from spikeTime files of model auditory 
...
#for stimRep in range(9,NStimReps):
