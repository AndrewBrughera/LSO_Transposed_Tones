# -*- coding: utf-8 -*-
"""
do25CF4p43LsoRM2fIPD4kHz.py

Calls a model LSO neuron type 2f (very fast membrane, lson from
lson25RM2f.py) with input from spikeTime files of model auditory nerve fibers 
...
Created on Fri 21 June 2019

@author: Andrew Brughera
"""
import os
from lson25CF4pXXRM2f import lson
...
#for stimRep in range(15,NStimReps):
    ...
    for modF in modFreqs_Hz:
        ...
        # ANSpTsCF04p43kHzCa04kHz1TT512HzEPhsN000SPL75dB18MdSp3
        # ANSpTsCaCF04kHz2TT800HzEPhsN720SPL75dB02MdSp3.txt
        for EPhsIdx in range(int(540/EPhsStep_deg)):
            # gbCoSpkFiles.append('ANSpTsCaCF04kHz1TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
            # sbIpSpkFiles.append('ANSpTsCaCF04kHz2TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
            # Lso2fSpTmsCaCF04kTT512HzTe0p2We10Ti0p4Wi100EIPDN015Co02EPhsN105.txt
            gbCoSpkFiles.append('ANSpTsCF04p43kHzCa04kHz1TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
            sbIpSpkFiles.append('ANSpTsCF04p43kHzCa04kHz2TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
