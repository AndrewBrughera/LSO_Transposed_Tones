# -*- coding: utf-8 -*-
"""
do25CF10p28LsoRM1bIPD10kHz.py

Calls a model LSO neuron type 1b (non-principal, fast membrane)
with input from spikeTime files of model auditory nerve fibers (CF 10.28 kHz) 
...
"""
import os
from lson25CF10pXXRM1b import lson
...
#for stimRep in range(15,NStimReps):
    ...
    for modF in modFreqs_Hz:
        ...
        # ANSpTsCF10p28kHzCa10kHz1TT512HzEPhsN000SPL75dB18MdSp3
        for EPhsIdx in range(int(540/EPhsStep_deg)):
            gbCoSpkFiles.append('ANSpTsCF10p28kHzCa10kHz1TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
            sbIpSpkFiles.append('ANSpTsCF10p28kHzCa10kHz2TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
