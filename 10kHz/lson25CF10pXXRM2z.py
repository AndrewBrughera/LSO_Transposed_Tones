...
#        EIPDstr = EIPDstr.replace('-','N')
    ...
    lsonSpkFile = 'Lso2zSpT' + anCoSpkFile[6:14] + anCoSpkFile[16:21] + anCoSpkFile[24:31] + 'Te'+Te + 'We'+We + 'Ti'+Ti + 'Wi'+Wi + EIPDstr + 'Co' + anCoSpkFile[46:48] + anCoSpkFile[31:39] + anCoSpkFile[53:]
