# -*- coding: utf-8 -*-
"""
do25LsoRM1bIPD6kHz.py

Calls a model LSO neuron type 1b (non-principal, fast membrane, 
lson from lson25RM1b.py) with input from spikeTime files of model auditory 
nerve fibers (Zilany et al., 2014) for 25 stimulus repetitions of transposed 
tones at 4 kHz, with modulation rates given in variable modFreqs_Hz.
...
for stimRep in range(22,NStimReps):
