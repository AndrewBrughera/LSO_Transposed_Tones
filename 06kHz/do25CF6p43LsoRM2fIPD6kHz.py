...
#for stimRep in range(15,NStimReps):
    ...
    for modF in modFreqs_Hz:
        ...
        # ANSpTsCF06p43kHzCa06kHz1TT512HzEPhsN000SPL75dB18MdSp3
        for EPhsIdx in range(int(540/EPhsStep_deg)):
            gbCoSpkFiles.append('ANSpTsCF06p43kHzCa06kHz1TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
            sbIpSpkFiles.append('ANSpTsCF06p43kHzCa06kHz2TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
