# -*- coding: utf-8 -*-
"""
do25LsoRM2IPD6kHz.py

Calls a model LSO neuron type 2 (fast membrane, tausE = 0.5*ms, lson from
lson25RM2.py) with input from spikeTime files of model auditory nerve fibers 
