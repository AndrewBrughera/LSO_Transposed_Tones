# -*- coding: utf-8 -*-
"""
do25CF6p28LsoRM1bIPD6kHz.py

Calls a model LSO neuron type 1b (non-principal, fast membrane)
with input from spikeTime files of model auditory nerve fibers (CF 6.28 kHz) 
...
Created on Fri 15 Apr 2020

@author: Andrew Brughera
"""
import os
from lson25CF6pXXRM1b import lson
...
for stimRep in range(4,NStimReps):
    ...
    for modF in modFreqs_Hz:
        ...
        # ANSpTsCF06p28kHzCa06kHz1TT512HzEPhsN000SPL75dB18MdSp3
        for EPhsIdx in range(int(540/EPhsStep_deg)):
            gbCoSpkFiles.append('ANSpTsCF06p28kHzCa06kHz1TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
            sbIpSpkFiles.append('ANSpTsCF06p28kHzCa06kHz2TT'+ str(modF).zfill(3) + 'HzEPhsN'+ str(EPhsIdx*EPhsStep_deg).zfill(3) + 'SPL75dB' + stimRepPlus1Str + 'MdSp3.txt')
