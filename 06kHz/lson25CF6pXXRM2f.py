# -*- coding: utf-8 -*-
"""
Model LSO Neuron Type "2f" - Andrew Brughera 2019 January to June, 
...
#        EIPDstr = EIPDstr.replace('-','N')
    ...
    lsonSpkFile = 'Lso2fSpTms' + anCoSpkFile[6:14] + anCoSpkFile[16:21] + anCoSpkFile[24:31] + 'Te'+Te + 'We'+We + 'Ti'+Ti + 'Wi'+Wi + EIPDstr + 'Co' + anCoSpkFile[46:48] + anCoSpkFile[31:39] + anCoSpkFile[53:]
