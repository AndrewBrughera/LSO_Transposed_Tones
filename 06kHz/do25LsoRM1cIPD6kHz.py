# -*- coding: utf-8 -*-
"""
do25LsoRM1cIPD6kHz.py

Calls a model LSO neuron type 1c (slow membrane, lson from
lson25RM1c.py) with input from spikeTime files of model auditory nerve fibers 
