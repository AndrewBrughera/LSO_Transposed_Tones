# -*- coding: utf-8 -*-
"""
Model LSO Neuron Type 1c - Andrew Brughera 2019 January to June, 
...
#    anfSpkGeneratorGrp = SpikeGeneratorGroup(nANF, anfIndices, anfSpkTimes)
    ...
    lsonSpkFile = 'Lso1cSpTms' + anCoSpkFile[10:17] + 'Te'+Te + 'We'+We + 'Ti'+Ti + 'Wi'+Wi + IIDdBStr + 'co'+dBSPLStrCo + 'ip'+dBSPLStrIp + anCoSpkFile[35:]
